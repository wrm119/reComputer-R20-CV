# YOLOv8 on Raspberry Pi 5 + Hailo-8
...
The `yolov8n.hef` shipped by the Model Zoo has the **NMS post-process layer baked
...
- `POST /api/models/yolov8/predict` — single-shot inference on uploaded image, video
...
## 7. Adapting to other models (yolov5, yolov8-seg, etc.)

Use this directory as the template:

1. Copy the whole `src/rpi5_hailo8_yolov8/` folder, rename to e.g.
   `rpi5_hailo8_yolov5/`.
